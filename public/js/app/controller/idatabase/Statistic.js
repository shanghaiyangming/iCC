Ext.define('icc.controller.idatabase.Statistic', {
	...
	stores : [ 'idatabase.Statistic.Type', 'idatabase.Statistic',
			'idatabase.Statistic.Series', 'idatabase.Statistic.Axis',
			'idatabase.Statistic.Method' ],
	views : [ 'idatabase.Statistic.Combobox.Type',
			'idatabase.Statistic.Combobox.Series',
			'idatabase.Statistic.Combobox.Axis',
	...
	init : function() {
		...
		listeners[controllerName + 'Grid button[action=save]'] = {
			click : function(button) {
				var records = me.getExpandedAccordion().store
						.getUpdatedRecords();
